...
//  final String x;
//  Event2({Key key, @required this.x}) : super(key: key);
...
class _Event2State extends State<Event2> {
  ...
  storeuser() async {
    ...
    await Firestore.instance.collection("Event2").document(userid).setData({
      "color": x,
      "userid": userid,
      "coin": 0,
      'time': DateTime.now(),
    ...
    return Scaffold(
      body: SafeArea(
        ...
        child: Column(children: [
            ...
            onPressed: () {
              ...
              if (s > 0) {
                 ...
                 Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (context) => Payment2(color: x),
                  ));
              } else {
                _showDialog2();
              }
          ...
          Row(children: <Widget>[
            Text(
              "Event time: x:16 min.   to x:30 min.",
